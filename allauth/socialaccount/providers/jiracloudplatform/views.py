...
class JiraCloudPlatformAuth2Adapter(OAuth2Adapter):
    provider_id = JiraCloudPlatformProvider.id
...
oauth2_callback = OAuth2CallbackView.adapter_view(JiraCloudPlatformAuth2Adapter)
